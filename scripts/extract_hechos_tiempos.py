#!/usr/bin/env python3
"""
Script para ejecutar el extractor de Hechos_Tiempos desde la API GraphQL.
"""
import sys
import json
...
# Configuración
QUERY_NAME = "hechos_tiempos"
GRAPHQL_DIR = Path('queries/graphql')
RESULTS_DIR = Path('output/api')


def main():
    """Ejecuta el extractor de Hechos_Tiempos"""
    print("="*80)
    print("EXTRACTOR: Hechos_Tiempos (API GraphQL)")
    print("="*80)
