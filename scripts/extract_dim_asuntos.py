#!/usr/bin/env python3
"""
Script para ejecutar el extractor de Dim_Asuntos desde la API GraphQL.
"""
import sys
import json
...
# Configuración
QUERY_NAME = "dim_asuntos"
GRAPHQL_DIR = Path('queries/graphql')
RESULTS_DIR = Path('output/api')


def main():
    """Ejecuta el extractor de Dim_Asuntos"""
    print("="*80)
    print("EXTRACTOR: Dim_Asuntos (API GraphQL)")
    print("="*80)
